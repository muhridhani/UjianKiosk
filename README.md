...
Workflow menyimpan debug keystore agar hasil build berikutnya memakai tanda tangan yang sama. Saat beralih dari versi 1.0.0 lama ke 1.1.0 ini, hapus aplikasi lama satu kali jika Android menolak pembaruan karena tanda tangan berbeda.
...
- Tekan dan tahan tulisan **SMPN 3 Sungai Pandan** selama 4 detik.
- Masukkan kode admin.
- Admin dapat mengganti alamat, mengganti kode, memuat ulang halaman, atau keluar aplikasi.
- Tombol **KELUAR** di kanan atas juga dapat digunakan, tetapi tetap meminta kode admin.
